...
- Spine-Leaf (CLOS) архитектура - широко применяемая в рамках высоконагруженных сетей архитекрута сети, состоящая из Leaf устройств, обеспецивающих подключение конечгый устройств, и 
...
**ICMP отклик от коммутатора S1 от коммутаторов L1,L2 и L3**

![S1](images/result_ping_S1.jpg)

**ICMP отклик от коммутатора S2 от коммутаторов L1,L2 и L3**

![S2](images/result_ping_S2.jpg)

А так же получения ответов со всех Leaf устройств от подключенных к нему конечных устройств.

**ICMP отклик от коммутатора L1 от конечного устройства PC11**

![L1](images/result_ping_L1.jpg)

**ICMP отклик от коммутатора L2 от конечного устройства PC21**

![L2](images/result_ping_L2.jpg)

**ICMP отклик от коммутатора L3 от конечных устройств PC31 и PC32**
...
Был подготовлен рабочий стенд, собранный в соответствии с CLOS архитекрурой. Произведены испытания, показавшие наличие доступности сетевых уровней Spine-Leaf.