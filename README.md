...
**ICPM отключк с коммутатора S1 от коммутаторов L1,L2 и L3**

![S1](images/result_ping_S1.jpg)

**ICPM отключк с коммутатора S2 от коммутаторов L1,L2 и L3**

![S2](images/result_ping_S2.jpg)

А так же получения ответов со всех Leaf устройств от подключенных к нему конечных устройств.

**ICPM отключк с коммутатора L1 от конечного устройства PC11**

![L1](images/result_ping_L1.jpg)

**ICPM отключк с коммутатора L2 от конечного устройства PC21**

![L2](images/result_ping_L2.jpg)

**ICPM отключк с коммутатора L3 от конечных устройств PC31 и PC32**
