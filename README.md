...
Для простоты восприятия дадим всем устройствам соответствующие имена:
...
Так же проверим получение ответов на всех Leaf устройствах от подключенных к ним конечных устройств.
